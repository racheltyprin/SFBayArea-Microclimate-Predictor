...
DATA SOURCE COVERAGE NOTE:
    Currently only Synoptic station data has been downloaded. ERA5 features are
    purely reanalysis (model output) and are source-agnostic — they apply equally
    to Synoptic and future WU stations without modification.
